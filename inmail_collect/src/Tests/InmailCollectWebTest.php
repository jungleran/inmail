...
class InmailCollectWebTest extends WebTestBase {
  ...
  public function testUi() {
    ...
    $this->assertText(Url::fromUri('user-path:inmail/message/message-id/21386_1392800717_530473CD_21386_78_1_OF72A6C464.8DF6E397-ONC1257C84.0031EBBB-C1257C84.0031EC2C@acacia.example.org', ['absolute' => TRUE]));
